...
FROM 'gs://rg_gcp_test/poc_sales_detail_extract_*.csv.gz' WITH FDELIM = ',', RDELIM = '\n', QUOTE = '"', AUTO_DETECT_COMPRESSION, HEADER, gcs_email = '<GCS_SA_EMAIL>', gcs_private_key_id = '<GCS_SA_KEY_ID>', gcs_private_key = '<GCS_SA_PRIVATE_KEY>';
